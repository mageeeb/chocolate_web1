/**
 * Gestion de la timeline et des étapes de recette avec animations
 * Anciennement recette.js
 */
  ...
  const steps = [
    {
      ...
      description:
        "Mélangez les œufs avec le sucre jusqu'à obtenir un mélange mousseux. Ajoutez l'huile et le lait, puis mélangez bien.",
    },
    {
      title: "Étape 2 : Ajouter les ingrédients secs",
      description:
        "Tamisez la farine avec le cacao et la levure. Incorporez délicatement au mélange précédent jusqu'à obtenir une pâte homogène.",
    },
    {
      title: "Étape 3 : Cuisson",
      description:
        "Versez la pâte dans un moule beurré et fariné. Faites cuire à 180°C pendant 25-30 minutes. Laissez refroidir complètement.",
    },
    {
      title: "Étape 4 : Préparer la ganache",
      description:
        "Faites chauffer la crème liquide sans la faire bouillir. Versez-la sur le chocolat concassé et mélangez jusqu'à obtenir une ganache lisse.",
    },
    {
      title: "Étape 5 : Découper et tremper",
      description:
        "Découpez le gâteau refroidi en petits cubes. Trempez chaque cube dans la ganache de chocolat en les enrobant bien.",
    },
    {
      title: "Étape 6 : Enrober de noix de coco",
      description:
        "Roulez immédiatement chaque cube dans la noix de coco râpée. Placez au réfrigérateur pendant au moins 2 heures avant de servir.",
    },
  ];
