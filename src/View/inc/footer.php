		<footer id="fh5co-footer" role="contentinfo" class="fh5co-section">
		    <img src="<?php CHEMIN ?>images/logos/logo-chocolat-deluxe.png" alt="Image de tablette de chocolat">
		    <div class="container">
		        <div class="row row-pb-md">
		            <div class="col-md-4 fh5co-widget">
		                <h4>Chocolada</h4>
		                <p>Le chocolat artisanal sublime les sens. Chaque bouchée révèle un monde de saveurs. Créé
		                    avec passion, il incarne l’élégance, la douceur et l’authenticité.</p>
		            </div>
		            ...
		            <div class="col-md-2 col-md-push-1 fh5co-widget">
		                <h4>Categories</h4>
		                <ul class="fh5co-footer-links">
		                    <li><a href="?pg=construct">Chocolat blanc</a></li>
		                    <li><a href="?pg=construct">Chocolat noir</a></li>
		                    <li><a href="?pg=construct">Chocolat au lait</a></li>
		                    <li><a href="?pg=construct">Chocolat ruby</a></li>
		                    <li><a href="?pg=construct">Chocolat aromatisé</a></li>
		                </ul>
		            </div>
